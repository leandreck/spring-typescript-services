...
class CollectionTypeNodeFactory implements ConcreteTypeNodeFactory {
    ...
    CollectionTypeNodeFactory(final TypeNodeFactory typeNodeFactory, final Elements elementUtils) {
    ...
    public TypeNode createTypeNode(final String fieldName, final String parameterName, final boolean optional, final TypeMirror typeMirror) {
        ...
        final TypeNode componentType = typeNodeFactory.createTypeNode(fieldName, parameterName, containingTypeMirror);
    ...
    private final class CollectionTypeNode extends TypeNode {
        ...
        public CollectionTypeNode(final boolean optional, final TypeNode containingType) {
            super(optional);
